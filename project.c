...
int Daemawiki() {
    struct Student students[] = {
        ...
        {1214, "5층 휴게실 문에 매달린걸로 오해받은 삐꾸", "Embedded", "자랑스러운 NoNamed"},
        {1215, "유니콘희영", "Unicorn", "자랑스러운 NoNamed"},
